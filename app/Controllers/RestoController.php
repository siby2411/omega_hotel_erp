...
class RestoController extends BaseController {
    ...
    public function resto_produits_create() {
        return $this->view('resto/create');
    }

    public function resto_produits_store() {
    ...
    public function resto_commandes() {
    ...
    public function resto_etats_financiers() {
